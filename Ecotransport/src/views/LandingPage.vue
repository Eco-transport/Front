<template>
  <div class="body" style="background-image: url('https://images.pexels.com/photos/34950/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260');">
      ...
      <div class="cajas">
        <div class="row justify-content-center">
          <div class="col-lg">
            ...
            <a class="btn btn-outline-success" href="/registro" role="button"
            >Registro</a>
          </div>
          <div class="col-lg">
...
<style scoped>
  ...
  h1 {
    ...
    line-height: 59px;
    color: #ffffff;
    text-shadow: 3px 4px 5px rgba(0, 0, 0, 0.9);
  }
  h3 {
    margin-top: 2px;
    font-size: 24px;
