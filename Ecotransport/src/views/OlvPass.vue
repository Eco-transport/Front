  ...
  <div>
    ...
    <div class="padre">
      <div class="hijo">
        ...
        <p><br /></p>
        <div>
          <p v-show="hideEmail">Escriba su correo:</p>
          <input v-show="hideEmail" v-model="email" placeholder="Correo electrónico">
        ...
        <div>
          <p v-show="hideCambioPassword">Escriba su nueva contraseña:</p>
          <input v-show="hideCambioPassword" v-model="nuevaPassword" placeholder="Nueva contraseña">
